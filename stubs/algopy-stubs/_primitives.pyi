...
_TByteLength = typing_extensions.TypeVar("_TByteLength", bound=int, default=int, covariant=True)


class Bytes(Reversible[Bytes], typing.Generic[_TByteLength]):
    """
    A byte sequence, one of the primary data types on the AVM.

    If _TByteLength is specified, the sequence must be of length _TByteLength
    else, a variable length sequence with a maximum length of 4096 bytes
    """
    ...
    def __add__(self, other: Bytes[typing.Any] | bytes) -> Bytes:
