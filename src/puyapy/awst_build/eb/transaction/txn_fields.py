...
PYTHON_TXN_FIELDS = {
    ...
    "note": PythonTxnField(TxnField.Note, pytypes.VarBytesType),
    "lease": PythonTxnField(TxnField.Lease, pytypes.VarBytesType),
    ...
    "vote_key": PythonTxnField(TxnField.VotePK, pytypes.VarBytesType),
    "selection_key": PythonTxnField(TxnField.SelectionPK, pytypes.VarBytesType),
    ...
    "type_bytes": PythonTxnField(TxnField.Type, pytypes.VarBytesType),
    ...
    "txn_id": PythonTxnField(TxnField.TxID, pytypes.VarBytesType),
    ...
    "approval_program": PythonTxnField(TxnField.ApprovalProgram, pytypes.VarBytesType),
    "clear_state_program": PythonTxnField(TxnField.ClearStateProgram, pytypes.VarBytesType),
    ...
    "unit_name": PythonTxnField(TxnField.ConfigAssetUnitName, pytypes.VarBytesType),
    "asset_name": PythonTxnField(TxnField.ConfigAssetName, pytypes.VarBytesType),
    "url": PythonTxnField(TxnField.ConfigAssetURL, pytypes.VarBytesType),
    "metadata_hash": PythonTxnField(TxnField.ConfigAssetMetadataHash, pytypes.VarBytesType),
    ...
    "last_log": PythonTxnField(TxnField.LastLog, pytypes.VarBytesType),
    "state_proof_key": PythonTxnField(TxnField.StateProofPK, pytypes.VarBytesType),
    ...
    "app_args": PythonTxnField(TxnField.ApplicationArgs, pytypes.VarBytesType),
    ...
    "logs": PythonTxnField(TxnField.Logs, pytypes.VarBytesType),
    "approval_program_pages": PythonTxnField(TxnField.ApprovalProgramPages, pytypes.VarBytesType),
    "clear_state_program_pages": PythonTxnField(
        TxnField.ClearStateProgramPages, pytypes.VarBytesType
    ),
}
