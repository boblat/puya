...
class AssetExpressionBuilder(UInt64BackedReferenceValueExpressionBuilder):
    def __init__(self, expr: Expression):
        ...
        field_mapping = {
            ...
            "unit_name": ("AssetUnitName", pytypes.VarBytesType),
            "name": ("AssetName", pytypes.VarBytesType),
            "url": ("AssetURL", pytypes.VarBytesType),
            "metadata_hash": ("AssetMetadataHash", pytypes.VarBytesType),
