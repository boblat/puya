...
import nypy.options
from nypy.modulefinder import ModuleNotFoundReason
from nypy.moduleinspect import InspectError, ModuleInspect
from nypy.nodes import PARAM_SPEC_KIND, TYPE_VAR_TUPLE_KIND, ClassDef, FuncDef, TypeAliasStmt
...
class AnnotationPrinter(TypeStrVisitor):
    ...
    * For Instance types it prints the fully qualified names.
    ...
    def __init__(
        ...
        super().__init__(options=nypy.options.Options())
