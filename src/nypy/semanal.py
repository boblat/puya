...
from nypy.semanal_enum import EnumCallAnalyzer
from nypy.semanal_namedtuple import NamedTupleAnalyzer
from nypy.semanal_newtype import NewTypeAnalyzer
from nypy.semanal_shared import (
...
from nypy.semanal_typeddict import TypedDictAnalyzer
from nypy.tvar_scope import TypeVarLikeScope
...
from nypy.typeops import function_type, get_type_vars, try_getting_str_literals_from_type
...
from nypy.types_utils import is_invalid_recursive_alias, store_argument_type
from nypy.typevars import fill_typevars
from nypy.util import correct_relative_import, is_dunder, module_prefix, unmangle, unnamed_function
        ...
        if import_id == "typing":
            ...
            if (
                ...
                if typing_extensions and source_id in typing_extensions.names:
                    ...
                    self.msg.note(
                        "See https://nypy.readthedocs.io/en/stable/runtime_troubles.html#using-new-additions-to-the-typing-module",
                        context,
                        code=codes.ATTR_DEFINED,
                    )
