...
from nypy.dmypy_server import Server
from nypy.dmypy_util import DEFAULT_STATUS_FILE
from nypy.errors import CompileError
from nypy.find_sources import create_source_list
from nypy.modulefinder import BuildSource
from nypy.options import Options
from nypy.server.mergecheck import check_consistency
from nypy.server.update import sort_messages_preserving_file_order
from nypy.test.config import test_temp_dir
from nypy.test.data import DataDrivenTestCase, DataSuite, DeleteFile, UpdateFile
from nypy.test.helpers import (
...
class FineGrainedSuite(DataSuite):
    ...
    def get_options(self, source: str, testcase: DataDrivenTestCase, build_cache: bool) -> Options:
        ...
        for name, _ in testcase.files:
            if "nypy.ini" in name or "pyproject.toml" in name:
