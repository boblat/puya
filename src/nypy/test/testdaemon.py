...
from nypy.dmypy_server import filter_out_missing_top_level_packages
from nypy.fscache import FileSystemCache
from nypy.modulefinder import SearchPaths
from nypy.test.config import PREFIX, test_temp_dir
from nypy.test.data import DataDrivenTestCase, DataSuite
from nypy.test.helpers import assert_string_arrays_equal, normalize_error_messages
...
def run_cmd(input: str) -> tuple[int, str]:
    ...
    if input.startswith("dmypy "):
        input = sys.executable + " -m nypy." + input
