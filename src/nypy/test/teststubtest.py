...
import nypy.stubtest
from nypy.stubtest import parse_options, test_stubs
from nypy.test.data import root_dir
...
class StubtestMiscUnit(unittest.TestCase):
    ...
    def test_get_typeshed_stdlib_modules(self) -> None:
        stdlib = nypy.stubtest.get_typeshed_stdlib_modules(None, (3, 7))
        ...
        stdlib = nypy.stubtest.get_typeshed_stdlib_modules(None, (3, 10))
    ...
    def test_signature(self) -> None:
        ...
        assert (
            str(nypy.stubtest.Signature.from_inspect_signature(inspect.signature(f)))
            == "def (a, b, *, c, d = ..., **kwargs)"
        )

    def test_builtin_signature_with_unrepresentable_default(self) -> None:
        sig = nypy.stubtest.safe_inspect_signature(bytes.hex)
        assert sig is not None
        assert (
            str(nypy.stubtest.Signature.from_inspect_signature(sig))
