...
import nypy.api as api
import nypy.version
from nypy import defaults
from nypy.main import process_options
from nypy.options import Options
from nypy.test.config import test_data_prefix, test_temp_dir
from nypy.test.data import DataDrivenTestCase, DeleteFile, UpdateFile, fix_cobertura_filename
...
def normalize_file_output(content: list[str], current_abs_path: str) -> list[str]:
    ...
    version = nypy.version.__version__
    ...
    base_version = getattr(nypy.version, "base_version", version)
