...
import nypy.test.testfinegrained


class FineGrainedCacheSuite(nypy.test.testfinegrained.FineGrainedSuite):
    use_cache = True
    test_name_suffix = "_cached"
    files = nypy.test.testfinegrained.FineGrainedSuite.files + [
