...
from nypy.nodes import ARG_STAR, FakeInfo, Var
...
from nypy.typevartuples import split_with_instance

# Solving the import cycle:
import nypy.type_visitor  # ruff: isort: skip
...
class FreshenCallableVisitor(nypy.type_visitor.TypeTranslator):
