...
from nypy import pyinfo
from nypy.errors import CompileError
from nypy.fscache import FileSystemCache
from nypy.nodes import MypyFile
from nypy.options import Options
from nypy.stubinfo import stub_distribution_name
from nypy.util import os_path_join
...
class ModuleNotFoundReason(Enum):
    ...
    def error_message_templates(self, daemon: bool) -> tuple[str, list[str]]:
        doc_link = "See https://nypy.readthedocs.io/en/stable/running_mypy.html#missing-imports"
...
def compute_search_paths(
    ...
    for site in site_packages:
        ...
        if (
            ...
            print(
                "See https://nypy.readthedocs.io/en/stable/running_mypy.html"
