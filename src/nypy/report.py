...
from nypy import stats
from nypy.defaults import REPORTER_NAMES
from nypy.nodes import Expression, FuncDef, MypyFile
from nypy.options import Options
from nypy.traverser import TraverserVisitor
from nypy.types import Type, TypeOfAny
...
class MemoryXmlReporter(AbstractReporter):
    ...
    def __init__(self, reports: Reports, output_dir: str) -> None:
        ...
        xsd_path = os.path.join(reports.data_dir, "xml", "nypy.xsd")
