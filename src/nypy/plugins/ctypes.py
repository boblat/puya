...
from nypy.messages import format_type
from nypy.subtypes import is_subtype
from nypy.typeops import make_simplified_union
...
def _find_simplecdata_base_arg(
    tp: Instance, api: nypy.plugin.CheckerPluginInterface
) -> ProperType | None:
...
def _autoconvertible_to_cdata(tp: Type, api: nypy.plugin.CheckerPluginInterface) -> Type:
...
def array_constructor_callback(ctx: nypy.plugin.FunctionContext) -> Type:
...
def array_getitem_callback(ctx: nypy.plugin.MethodContext) -> Type:
...
def array_setitem_callback(ctx: nypy.plugin.MethodSigContext) -> CallableType:
...
def array_iter_callback(ctx: nypy.plugin.MethodContext) -> Type:
...
def array_value_callback(ctx: nypy.plugin.AttributeContext) -> Type:
...
def array_raw_callback(ctx: nypy.plugin.AttributeContext) -> Type:
