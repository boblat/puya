...
from nypy import message_registry
from nypy.nodes import DictExpr, IntExpr, StrExpr, UnaryExpr
...
from nypy.plugins.common import try_getting_str_literals
from nypy.subtypes import is_subtype
from nypy.typeops import is_literal_type_like, make_simplified_union
...
class DefaultPlugin(Plugin):
    ...
    def get_function_hook(self, fullname: str) -> Callable[[FunctionContext], Type] | None:
        from nypy.plugins import ctypes, enums, singledispatch
        ...
        if fullname == "_ctypes.Array":
            ...
            import nypy.plugins.functools

            return nypy.plugins.functools.partial_new_callback
    ...
    def get_function_signature_hook(
        ...
        from nypy.plugins import attrs, dataclasses
    ...
    def get_method_signature_hook(
        ...
        from nypy.plugins import ctypes, singledispatch
    ...
    def get_method_hook(self, fullname: str) -> Callable[[MethodContext], Type] | None:
        ...
        if fullname == "typing.Mapping.get":
            ...
            return nypy.plugins.functools.partial_call_callback
        return None

    def get_attribute_hook(self, fullname: str) -> Callable[[AttributeContext], Type] | None:
        from nypy.plugins import ctypes, enums
    ...
    def get_class_decorator_hook_2(
        ...
        elif fullname in nypy.plugins.functools.functools_total_ordering_makers:
            return nypy.plugins.functools.functools_total_ordering_maker_callback
