...
from nypy.nodes import ARG_POS, CallExpr, Decorator, Expression, FuncDef, RefExpr, Var
from nypy.semanal_shared import SemanticAnalyzerInterface
from nypy.typeops import function_type
...
from nypy.typevars import has_no_typevars
