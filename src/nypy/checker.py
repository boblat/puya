...
import nypy.checkexpr
from nypy import errorcodes as codes, join, message_registry, nodes, operators
from nypy.binder import ConditionalTypeBinder, Frame, get_declaration
from nypy.checkmember import (
    MemberContext,
...
from nypy.checkpattern import PatternChecker
...
from nypy.meet import is_overlapping_erased_types, is_overlapping_types, meet_types
...
from nypy.mro import MroError, calculate_mro
...
from nypy.operators import flip_ops, int_op_to_method, neg_ops
from nypy.options import PRECISE_TUPLE_TYPES, Options
from nypy.patterns import AsPattern, StarredPattern
from nypy.plugin import CheckerPluginInterface, Plugin
from nypy.plugins import dataclasses as dataclasses_plugin
from nypy.scope import Scope
from nypy.semanal import is_trivial_body, refers_to_fullname, set_callable_name
from nypy.semanal_enum import ENUM_BASES, ENUM_SPECIAL_PROPS
from nypy.sharedparse import BINARY_MAGIC_METHODS
from nypy.state import state
from nypy.subtypes import (
    find_member,
...
from nypy.traverser import TraverserVisitor, all_return_statements, has_return_statement
from nypy.treetransform import TransformVisitor
from nypy.typeanal import check_for_explicit_any, has_any_from_unimported_type, make_optional_type
from nypy.typeops import (
    bind_self,
    coerce_to_literal,
...
from nypy.types_utils import is_overlapping_none, remove_optional, store_argument_type, strip_type
from nypy.typetraverser import TypeTraverserVisitor
from nypy.typevars import fill_typevars, fill_typevars_with_any, has_no_typevars
from nypy.util import is_dunder, is_sunder
...
class TypeChecker(NodeVisitor[None], CheckerPluginInterface):
    ...
    expr_checker: nypy.checkexpr.ExpressionChecker
                ...
                for i in range(len(typ.arg_types)):
                    ...
                    if (
                        ...
                        if defn.is_class or defn.name == "__new__":
                            ref_type = nypy.types.TypeType.make_normalized(ref_type)
    ...
    def check_untyped_after_decorator(self, typ: Type, func: FuncDef) -> None:
        ...
        if nypy.checkexpr.has_any_type(typ):
