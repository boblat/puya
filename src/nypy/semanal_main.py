...
def check_type_arguments(graph: Graph, scc: list[str], errors: Errors) -> None:
    for module in scc:
        ...
        with state.wrap_context():
            with nypy.state.state.strict_optional_set(state.options.strict_optional):
