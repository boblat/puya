...
from nypy.copytype import copy_type
...
def bind_self(
    ...
    if func.variables and supported_self_type(
        ...
        from nypy.infer import infer_type_arguments
...
def is_valid_self_type_best_effort(c: CallableType, self_type: Instance) -> bool:
    ...
    if (
        ...
        from nypy.meet import is_overlapping_types
...
def get_protocol_member(left: Instance, member: str, class_obj: bool) -> ProperType | None:
    if member == "__call__" and class_obj:
        ...
        from nypy.checkmember import type_object_type
    ...
    from nypy.subtypes import find_member
