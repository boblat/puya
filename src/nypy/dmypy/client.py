...
from nypy.dmypy_os import alive, kill
from nypy.dmypy_util import DEFAULT_STATUS_FILE, receive, send
from nypy.ipc import IPCClient, IPCException
from nypy.util import check_python_version, get_terminal_width, should_force_color
...
def start_server(args: argparse.Namespace, allow_sources: bool = False) -> None:
    ...
    from nypy.dmypy_server import daemonize, process_start_options
...
def check_output(
    ...
    if junit_xml:
        ...
        from nypy.util import write_junit_xml
...
def do_daemon(args: argparse.Namespace) -> None:
    ...
    # Lazy import so this import doesn't slow down other commands.
    from nypy.dmypy_server import Server, process_start_options
