...
class NodeVisitor(Generic[T], ExpressionVisitor[T], StatementVisitor[T], PatternVisitor[T]):
    ...
    def visit_mypy_file(self, o: nypy.nodes.MypyFile, /) -> T:
        pass
    ...
    def visit_var(self, o: nypy.nodes.Var, /) -> T:
        pass
    ...
    def visit_type_alias(self, o: nypy.nodes.TypeAlias, /) -> T:
        pass

    def visit_placeholder_node(self, o: nypy.nodes.PlaceholderNode, /) -> T:
        pass
