...
from nypy.typeops import is_recursive_pair, make_simplified_union, tuple_fallback
...
def meet_similar_callables(t: CallableType, s: CallableType) -> CallableType:
    from nypy.join import match_generic_callables, safe_join
