...
from nypy.errors import ErrorInfo, Errors, ErrorWatcher
...
from nypy.operators import op_methods, op_methods_to_symbols
...
from nypy.typeops import separate_union_literals
...
from nypy.util import plural_s, unmangle
...
class MessageBuilder:
    ...
    def argument_incompatible_with_supertype(
        ...
        if name != "__post_init__":
            ...
            self.note(
                "See https://nypy.readthedocs.io/en/stable/common_issues.html#incompatible-overrides",
                context,
                code=codes.OVERRIDE,
                secondary_context=secondary_context,
            )
    ...
    def return_type_incompatible_with_supertype(
        ...
        if (
            ...
            self.note(
                "See https://nypy.readthedocs.io/en/stable/more_types.html#asynchronous-iterators",
                context,
            )
...
def append_invariance_notes(
    ...
    if invariant_type and covariant_suggestion:
        notes.append(
            ...
            + "https://nypy.readthedocs.io/en/stable/common_issues.html#variance"
        )
