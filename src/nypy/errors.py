...
from nypy.error_formatter import ErrorFormatter
from nypy.errorcodes import IMPORT, IMPORT_NOT_FOUND, IMPORT_UNTYPED, ErrorCode, mypy_error_codes
from nypy.message_registry import ErrorMessage
from nypy.options import Options
from nypy.scope import Scope
from nypy.util import DEFAULT_SOURCE_OFFSET, is_typeshed_file
from nypy.version import __version__ as mypy_version
...
BASE_RTD_URL: Final = "https://nypy.rtfd.io/en/stable/_refs.html#code"
...
def report_internal_error(
    ...
    print(
        ...
        "https://nypy.readthedocs.io/en/stable/common_issues.html"
