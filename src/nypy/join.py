...
from nypy.nodes import CONTRAVARIANT, COVARIANT, INVARIANT, VARIANCE_NOT_READY
...
def join_simple(declaration: Type | None, s: Type, t: Type) -> ProperType:
    ...
    if (s.can_be_true, s.can_be_false) != (t.can_be_true, t.can_be_false):
        ...
        s = nypy.typeops.true_or_false(s)
        t = nypy.typeops.true_or_false(t)
    ...
    if isinstance(declaration, UnionType):
        return nypy.typeops.make_simplified_union([s, t])
...
def join_types(s: Type, t: Type, instance_joiner: InstanceJoiner | None = None) -> Type:
    ...
    """
    if nypy.typeops.is_recursive_pair(s, t):
...
class TypeJoinVisitor(TypeVisitor[ProperType]):
    ...
    def visit_union_type(self, t: UnionType) -> ProperType:
        if is_proper_subtype(self.s, t):
            ...
            return nypy.typeops.make_simplified_union([self.s, t])
    ...
    def visit_tuple_type(self, t: TupleType) -> ProperType:
        ...
        if isinstance(self.s, TupleType):
            ...
            fallback = self.instance_joiner.join_instances(
                nypy.typeops.tuple_fallback(self.s), nypy.typeops.tuple_fallback(t)
            )
            ...
            return join_types(self.s, nypy.typeops.tuple_fallback(t))
    ...
    def default(self, typ: Type) -> ProperType:
        ...
        if isinstance(typ, Instance):
            ...
            return self.default(nypy.typeops.tuple_fallback(typ))
