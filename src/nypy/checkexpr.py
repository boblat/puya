...
import nypy.checker
import nypy.errorcodes as codes
from nypy import applytype, erasetype, join, message_registry, nodes, operators, types
from nypy.argmap import ArgTypeExpander, map_actuals_to_formals, map_formals_to_actuals
...
from nypy.infer import ArgumentInferContext, infer_function_type_arguments, infer_type_arguments
from nypy.literals import literal
from nypy.maptype import map_instance_to_supertype
from nypy.meet import is_overlapping_types, narrow_declared_type
from nypy.message_registry import ErrorMessage
from nypy.messages import MessageBuilder, format_type
...
from nypy.options import PRECISE_TUPLE_TYPES
from nypy.plugin import (
    FunctionContext,
    FunctionSigContext,
    MethodContext,
    MethodSigContext,
...
from nypy.semanal_enum import ENUM_BASES
...
from nypy.traverser import has_await_expression
from nypy.typeanal import (
...
from nypy.util import split_module_names
...
class ExpressionChecker(ExpressionVisitor[Type]):
    ...
    def visit_call_expr_inner(self, e: CallExpr, allow_none_return: bool = False) -> Type:
        ...
        if (
            ...
            for typ in nypy.checker.flatten(e.args[1]):
                node = None
    ...
    def check_runtime_protocol_test(self, e: CallExpr) -> None:
        for expr in nypy.checker.flatten(e.args[1]):
    ...
    def try_infer_partial_type(self, e: CallExpr) -> None:
        ...
        if isinstance(callee.expr, RefExpr):
            ...
            if value_type is not None:
                ...
                if nypy.checker.is_valid_inferred_type(key_type):
    ...
    def try_infer_partial_value_type_from_call(
        ...
        if (
            ...
            if nypy.checker.is_valid_inferred_type(item_type):
            ...
            if isinstance(arg_type, Instance):
                ...
                if arg_typename in self.container_args[typename][methodname]:
                    if all(
                        nypy.checker.is_valid_inferred_type(item_type)
    ...
    def check_boolean_op(self, e: OpExpr, context: Context) -> Type:
        ...
        if e.right_always:
            left_map: nypy.checker.TypeMap = None
            right_map: nypy.checker.TypeMap = {}
    ...
    def visit_assert_type_expr(self, expr: AssertTypeExpr) -> Type:
        ...
        if (
            isinstance(proper_source_type, nypy.types.Instance)
    ...
    def visit_conditional_expr(self, e: ConditionalExpr, allow_none_return: bool = False) -> Type:
        ...
        if not nypy.checker.is_valid_inferred_type(if_type):
