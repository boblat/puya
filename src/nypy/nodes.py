...
from nypy.util import is_typeshed_file, short_type
from nypy.visitor import ExpressionVisitor, NodeVisitor, StatementVisitor

if TYPE_CHECKING:
    from nypy.patterns import Pattern
...
class Node(Context):
    ...
    def __str__(self) -> str:
        ans = self.accept(nypy.strconv.StrConv(options=Options()))
        if ans is None:
            return repr(self)
        return ans
...
class FuncBase(Node):
    ...
    def __init__(self) -> None:
        ...
        self.type: nypy.types.ProperType | None = None
        # Original, not semantically analyzed type (used for reprocessing)
        self.unanalyzed_type: nypy.types.ProperType | None = None
...
class OverloadedFuncDef(FuncBase, SymbolNode, Statement):
    ...
    def deserialize(cls, data: JsonDict) -> OverloadedFuncDef:
        ...
        if data.get("type") is not None:
            typ = nypy.types.deserialize_type(data["type"])
            assert isinstance(typ, nypy.types.ProperType)
            res.type = typ
...
class Argument(Node):
    ...
    def __init__(
        self,
        variable: Var,
        type_annotation: nypy.types.Type | None,
...
class TypeParam:
    ...
    def __init__(
        ...
        name: str,
        kind: int,
        upper_bound: nypy.types.Type | None,
        values: list[nypy.types.Type],
        default: nypy.types.Type | None,
    ) -> None:
        self.name = name
        self.kind = kind
...
class FuncItem(FuncBase):
    ...
    def __init__(
        ...
        typ: nypy.types.FunctionLike | None = None,
    ...
    def deserialize(cls, data: JsonDict) -> FuncDef:
        ...
        ret = FuncDef(
            ...
            (
                ...
                else cast(nypy.types.FunctionLike, nypy.types.deserialize_type(data["type"]))
            ),
        )
...
class Decorator(SymbolNode, Statement):
    ...
    @property
    def type(self) -> nypy.types.Type | None:
...
class Var(SymbolNode):
    ...
    def __init__(self, name: str, type: nypy.types.Type | None = None) -> None:
        super().__init__()
        ...
        self.type: nypy.types.Type | None = type  # Declared or inferred type, or None
    ...
    def deserialize(cls, data: JsonDict) -> Var:
        ...
        name = data["name"]
        type = None if data["type"] is None else nypy.types.deserialize_type(data["type"])
        v = Var(name, type)
...
class ClassDef(Statement):
    ...
    type_vars: list[nypy.types.TypeVarLikeType]
    ...
    def __init__(
        ...
        name: str,
        defs: Block,
        type_vars: list[nypy.types.TypeVarLikeType] | None = None,
    ...
    def deserialize(cls, data: JsonDict) -> ClassDef:
        ...
        res = ClassDef(
            ...
            [
                cast(nypy.types.TypeVarLikeType, nypy.types.deserialize_type(v))
...
class AssignmentStmt(Statement):
    ...
    def __init__(
        ...
        lvalues: list[Lvalue],
        rvalue: Expression,
        type: nypy.types.Type | None = None,
...
class ForStmt(Statement):
    ...
    index_type: nypy.types.Type | None
    # Original, not semantically analyzed type in annotation (used for reprocessing)
    unanalyzed_index_type: nypy.types.Type | None
    # Inferred iterable item type
    inferred_item_type: nypy.types.Type | None
    # Inferred iterator type
    inferred_iterator_type: nypy.types.Type | None
    ...
    def __init__(
        ...
        body: Block,
        else_body: Block | None,
        index_type: nypy.types.Type | None = None,
    ) -> None:
        super().__init__()
        self.index = index
...
class WithStmt(Statement):
    ...
    analyzed_types: list[nypy.types.Type]
    body: Block
    ...
    def __init__(
        ...
        target: list[Lvalue | None],
        body: Block,
        target_type: nypy.types.Type | None = None,
    ) -> None:
        super().__init__()
        self.expr = expr
        self.target = target
...
class RefExpr(Expression):
    ...
    def __init__(self) -> None:
        ...
        self.type_guard: nypy.types.Type | None = None
        # And same for TypeIs
        self.type_is: nypy.types.Type | None = None
...
class IndexExpr(Expression):
    ...
    method_type: nypy.types.Type | None
...
class ComparisonExpr(Expression):
    ...
    method_types: list[nypy.types.Type | None]
...
class CastExpr(Expression):
    ...
    expr: Expression
    type: nypy.types.Type

    def __init__(self, expr: Expression, typ: nypy.types.Type) -> None:
        super().__init__()
        self.expr = expr
        self.type = typ
...
class TypeApplication(Expression):
    ...
    expr: Expression
    types: list[nypy.types.Type]

    def __init__(self, expr: Expression, types: list[nypy.types.Type]) -> None:
        super().__init__()
        self.expr = expr
        self.types = types
...
class TypeVarExpr(TypeVarLikeExpr):
    ...
    def deserialize(cls, data: JsonDict) -> TypeVarExpr:
        ...
        return TypeVarExpr(
            data["name"],
            data["fullname"],
            [nypy.types.deserialize_type(v) for v in data["values"]],
            nypy.types.deserialize_type(data["upper_bound"]),
            nypy.types.deserialize_type(data["default"]),
            data["variance"],
        )
...
class TypeVarTupleExpr(TypeVarLikeExpr):
    ...
    tuple_fallback: nypy.types.Instance
    ...
    def deserialize(cls, data: JsonDict) -> TypeVarTupleExpr:
        ...
        return TypeVarTupleExpr(
            ...
            data["fullname"],
            nypy.types.deserialize_type(data["upper_bound"]),
            nypy.types.Instance.deserialize(data["tuple_fallback"]),
            nypy.types.deserialize_type(data["default"]),
            data["variance"],
        )
...
class PromoteExpr(Expression):
    ...
    type: nypy.types.ProperType

    def __init__(self, type: nypy.types.ProperType) -> None:
        super().__init__()
        self.type = type
...
class NewTypeExpr(Expression):
    ...
    old_type: nypy.types.Type | None
    # The synthesized class representing the new type (inherits old_type)
    info: TypeInfo | None

    def __init__(
        self, name: str, old_type: nypy.types.Type | None, line: int, column: int
    ) -> None:
...
class TempNode(Expression):
    ...
    def __init__(
        self, typ: nypy.types.Type, no_rhs: bool = False, *, context: Context | None = None
    ) -> None:
...
class TypeInfo(SymbolNode):
    ...
    declared_metaclass: nypy.types.Instance | None
    metaclass_type: nypy.types.Instance | None
    ...
    assuming: list[tuple[nypy.types.Instance, nypy.types.Instance]]
    assuming_proper: list[tuple[nypy.types.Instance, nypy.types.Instance]]
    ...
    # -> infer_constraints.
    inferring: list[nypy.types.Instance]
    ...
    # Direct base classes.
    bases: list[nypy.types.Instance]
    ...
    _promote: list[nypy.types.ProperType]
    ...
    alt_promote: nypy.types.Instance | None
    ...
    # tuple type.
    tuple_type: nypy.types.TupleType | None
    ...
    typeddict_type: nypy.types.TypedDictType | None
    ...
    self_type: nypy.types.TypeVarType | None
    ...
    def add_type_vars(self) -> None:
        ...
        if self.defn.type_vars:
            for i, vd in enumerate(self.defn.type_vars):
                if isinstance(vd, nypy.types.ParamSpecType):
                    self.has_param_spec_type = True
                if isinstance(vd, nypy.types.TypeVarTupleType):
    ...
    def calculate_metaclass_type(self) -> nypy.types.Instance | None:
        declared = self.declared_metaclass
        if declared is not None and not declared.type.has_base("builtins.type"):
            return declared
        if self._fullname == "builtins.type":
            return nypy.types.Instance(self, [])
        candidates = [
    ...
    def update_tuple_type(self, typ: nypy.types.TupleType) -> None:
    ...
    def update_typeddict_type(self, typ: nypy.types.TypedDictType) -> None:
    ...
    def __str__(self) -> str:
        ...
        options = Options()
        return self.dump(
            str_conv=nypy.strconv.StrConv(options=options),
            type_str_conv=nypy.types.TypeStrVisitor(options=options),
        )

    def dump(
        self, str_conv: nypy.strconv.StrConv, type_str_conv: nypy.types.TypeStrVisitor
    ) -> str:
        """Return a string dump of the contents of the TypeInfo."""

        base: str = ""

        def type_str(typ: nypy.types.Type) -> str:
        ...
        return nypy.strconv.dump_tagged(items, head, str_conv=str_conv)
    ...
    def deserialize(cls, data: JsonDict) -> TypeInfo:
        ...
        ti.bases = [nypy.types.Instance.deserialize(b) for b in data["bases"]]
        _promote = []
        for p in data["_promote"]:
            t = nypy.types.deserialize_type(p)
            assert isinstance(t, nypy.types.ProperType)
            _promote.append(t)
        ti._promote = _promote
        ti.alt_promote = (
            None
            if data["alt_promote"] is None
            else nypy.types.Instance.deserialize(data["alt_promote"])
        )
        ti.declared_metaclass = (
            None
            if data["declared_metaclass"] is None
            else nypy.types.Instance.deserialize(data["declared_metaclass"])
        )
        ti.metaclass_type = (
            None
            if data["metaclass_type"] is None
            else nypy.types.Instance.deserialize(data["metaclass_type"])
        )
        ...
        ti.tuple_type = (
            ...
            else nypy.types.TupleType.deserialize(data["tuple_type"])
        )
        ti.typeddict_type = (
            None
            if data["typeddict_type"] is None
            else nypy.types.TypedDictType.deserialize(data["typeddict_type"])
        )
        ...
        st = data["self_type"]
        ti.self_type = nypy.types.TypeVarType.deserialize(st) if st is not None else None
...
class TypeAlias(SymbolNode):
    ...
    def __init__(
        self,
        target: nypy.types.Type,
        fullname: str,
        line: int,
        column: int,
        *,
        alias_tvars: list[nypy.types.TypeVarLikeType] | None = None,
        no_args: bool = False,
        ...
        for i, t in enumerate(alias_tvars):
            if isinstance(t, nypy.types.TypeVarTupleType):
    ...
    def from_tuple_type(cls, info: TypeInfo) -> TypeAlias:
        ...
        return TypeAlias(
            info.tuple_type.copy_modified(
                ...
                fallback=nypy.types.Instance(
                    info, nypy.types.type_vars_as_args(info.defn.type_vars)
                )
            ),
            info.fullname,
            info.line,
    ...
    def has_param_spec_type(self) -> bool:
        return any(isinstance(v, nypy.types.ParamSpecType) for v in self.alias_tvars)
    ...
    def deserialize(cls, data: JsonDict) -> TypeAlias:
        ...
        alias_tvars = [nypy.types.deserialize_type(v) for v in data["alias_tvars"]]
        assert all(isinstance(t, nypy.types.TypeVarLikeType) for t in alias_tvars)
        target = nypy.types.deserialize_type(data["target"])
        ...
        return cls(
            ...
            line,
            column,
            alias_tvars=cast(list[nypy.types.TypeVarLikeType], alias_tvars),
            no_args=no_args,
