...
from nypy import errorcodes as codes, message_registry, nodes
from nypy.errorcodes import ErrorCode
from nypy.expandtype import expand_type
from nypy.message_registry import (
...
from nypy.options import INLINE_TYPEDDICT, Options
from nypy.plugin import AnalyzeTypeContext, Plugin, TypeAnalyzerPluginInterface
...
from nypy.types_utils import get_bad_type_type_item
...
class TypeAnalyser(SyntheticTypeVisitor[Type], TypeAnalyzerPluginInterface):
    ...
    def analyze_unbound_type_without_type_info(
        ...
        if isinstance(sym.node, Var):
            notes.append(
                "See https://nypy.readthedocs.io/en/"
        ...
        if len(t.args) == 0:
            ...
            if isinstance(callable_args, TypeList):
                ...
                if maybe_ret is None:
                    ...
                    self.note(
                        "See https://nypy.readthedocs.io/en/stable/kinds_of_types.html#callable-types-and-lambdas",
                        t,
                    )
                    return AnyType(TypeOfAny.from_error)
        ...
        if fullname in nongen_builtins:
            ...
            if (
                ...
                note(
                    ...
                    "escaping, see https://nypy.readthedocs.io/en/stable/runtime_troubles.html"
                    "#not-generic-runtime",
                    typ,
                    code=codes.TYPE_ARG,
                )
